  ...
  <q-layout view="hHh lpR fFf" class="shell">
    <q-header bordered class="app-header">
      ...
      <q-tabs align="left" inline-label class="app-tabs">
        ...
        <q-route-tab icon="handyman" :label="$t('app.nav.housekeeping')" to="/vzdrzevanje" />
        <q-route-tab icon="shopping_cart" :label="$t('app.nav.equipmentOrders')" to="/narocila" />
        <q-route-tab icon="folder_copy" :label="$t('app.nav.documents')" to="/dokumenti" />
      </q-tabs>
    </q-header>
